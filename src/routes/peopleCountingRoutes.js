...
router.post(
  "/locations",
  requirePermission("system.people_counting.location.create"),
  asyncHandler(async (req, res) => {
...
router.put(
  "/locations/:id",
  requirePermission("system.people_counting.location.update"),
  validateIntegers("id"),
  asyncHandler(async (req, res) => {
    const { id } = req.params;
...
router.delete(
  "/locations/:id",
  requirePermission("system.people_counting.location.delete"),
  validateIntegers("id"),
  asyncHandler(async (req, res) => {
    const { id } = req.params;
